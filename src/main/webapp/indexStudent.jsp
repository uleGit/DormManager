    ...
    <div class="sidebar">
        ...
        <div class="option">
            <ul>
                ...
                <li><img src="images/works.png" alt="">
                    <p><a href="addRepair.jsp" target="mainFrame" style="text-decoration:none;">上报维修</a></p>
                </li>
                <li><img src="images/collection.png" alt="">
                    <p><a href="selectRepair.jsp" target="mainFrame" style="text-decoration:none;">维修信息查看</a></p>
                </li>
            </ul>
        </div>
    </div>
